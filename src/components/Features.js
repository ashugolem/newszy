          ...
          <div className="row gy-4 gy-md-0">
            ...
            <div className="col">
              <div style={{ maxWidth: "450px" }}>
                <h3 className="fw-bold pb-md-4" data-aos="zoom-in">
                  Features that make your stay connected to the world
                </h3>
                <p
                  className="text-muted py-4 py-md-0"
                  data-aos="fade"
                  data-aos-delay="450"
                >
                  A cutting-edge news website revolutionizing the way
                  information is delivered, captivating readers with captivating
                  content and unrivaled user experience.
                </p>
